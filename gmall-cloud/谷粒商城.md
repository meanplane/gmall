...
```json
{
  skuId:long,
  spuId:keyword,
  skuTitle:text(ik_smart),
  skuPrice:keyword,
  skuImg:keyword(index:false,doc_values:false),
  saleCount:long,
  hasStock:boolean,
  hotScore:long,
  brandId:long,
  ...
  brandImg:keyword(index:false,doc_values:false),
  categoryName:keyword(index:false,doc_values:false),
  attrs:{
    type:nested,
    properties:{
      attrId:{
